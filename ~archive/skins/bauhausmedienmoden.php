 ...
 * $wgDefaultSkin = 'bauhausmedienmoden'
 */
...
class SkinBauhausMedienModen extends SkinBauhausMedienTemplate {

	function initPage( OutputPage $out ) {
		parent::initPage( $out );
		$this->skinname  = 'bauhausmedienmoden';
		$this->stylename = 'bauhausmedienmoden';
		$this->template  = 'bauhausmedienmodenTemplate';
	}

	function setupSkinUserCss( OutputPage $out ) {
		parent::setupSkinUserCss( $out );
		// add custom stlye
		$out->addStyle( 'bauhausmedien/_bauhausmedienmoden.css', 'screen' );
	}
...
class BauhausMedienModenTemplate extends BauhausMedienTemplate {
	...
	function initPrfs() {
		...
		$this->templPrefs['favicon']			= '/bauhausmedien/favicon_medien.ico';
