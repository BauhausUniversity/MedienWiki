 ...
 * $wgDefaultSkin = 'bauhausmedienfoto'
 */
...
class SkinBauhausMedienFoto extends SkinBauhausMedienTemplate {

	function initPage( OutputPage $out ) {
		parent::initPage( $out );
		$this->skinname  = 'bauhausmedienfoto';
		$this->stylename = 'bauhausmedienfoto';
		$this->template  = 'bauhausmedienfotoTemplate';
	}

	function setupSkinUserCss( OutputPage $out ) {
		parent::setupSkinUserCss( $out );
		// add custom stlye
		// eg: $out->addStyle( 'bauhausmedien/_bauhausmedienfoto.css', 'screen' );
	}
...
class BauhausMedienFotoTemplate extends BauhausMedienTemplate {
