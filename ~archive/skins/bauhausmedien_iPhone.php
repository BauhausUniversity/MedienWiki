<?php
/**
 * Bauhaus Medien for iPhone
 * Adapted from Bauhausmedien
 * by Michael Markert
 ...
 * @ingroup Skins
 */
class SkiniPhone extends SkinTemplate {
	/** Using monobook. */
	function initPage( &$out ) {
		SkinTemplate::initPage( $out );
		$this->skinname  = 'bauhausmedien_iphone';
		$this->stylename = 'iphone';
		$this->template  = 'iPhoneTemplate';
 ...
 * @ingroup Skins
 */
class iPhoneTemplate extends QuickTemplate {
	var $skin;
	/**
...
<html xmlns="<?php $this->text('xhtmldefaultnamespace') ?>" <?php 
	...
	<script type="text/javascript" src="/skins/iphone/jquery.js"></script>
	<script type="text/javascript" src="/skins/iphone/chili-1.7.pack.js"></script>
	
	<script type="text/javascript" src="/skins/iphone/jquery.easing.js"></script>
	<script type="text/javascript" src="/skins/iphone/jquery.dimensions.js"></script>
	<script type="text/javascript" src="/skins/iphone/jquery.accordion.js"></script>

	<script type="text/javascript">
	jQuery().ready(function(){
		
		// highly customized accordion
		jQuery('#column-one').accordion({
			event: 'click',
			active: '.selected',
			selectedClass: 'accordion_toggle_active',
			animated: "easeslide",
			header: "h5"
		...
		var accordions = jQuery('#column-one');
...
<?php if($this->data['body_onload']) { ?> onload="<?php $this->text('body_onload') ?>"<?php } ?>
 class="mediawiki <?php $this->text('nsclass') ?> <?php $this->text('dir') ?> <?php $this->text('pageclass') ?>">
	...
	<div id="p-cactions" class="portlet">
		<h5 class="accordion_toggle"><?php $this->msg('views') ?></h5>
		<div class="pBody accordion_content">
			<ul>
	...
	<div class="portlet" id="p-personal">
		<h5 class="accordion_toggle"><?php $this->msg('personaltools') ?></h5>
		<div class="pBody accordion_content">
			<ul>
...
?>
	...
	<?php if($this->data['loggedin']) { ?>
		<h5 class="accordion_toggle"><label for="searchInput"><?php $this->msg('search') ?></label></h5>
		<div id="searchBody" class="pBody accordion_content">
...
?>
	...
	<?php if($this->data['loggedin']) { ?>
		<h5 class="accordion_toggle"><?php $this->msg('toolbox') ?></h5>
		<div class="pBody accordion_content">
			<ul>
<?php
...
?>
	<div id="p-lang" class="portlet">
		<h5 class="accordion_toggle"><?php $this->msg('otherlanguages') ?></h5>
		<div class="pBody accordion_content">
			<ul>
...
?>
	<div class='generated-sidebar portlet' id='p-<?php echo Sanitizer::escapeId($bar) ?>'<?php echo $this->skin->tooltip('p-'.$bar) ?>>
		<h5 class="accordion_toggle"><?php $out = wfMsg( $bar ); if (wfEmptyMsg($bar, $out)) echo $bar; else echo $out; ?></h5>
		<div class='pBody'>
